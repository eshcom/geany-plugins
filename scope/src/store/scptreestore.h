...
#define SCP_TREE_STORE(obj)				\
	(G_TYPE_CHECK_INSTANCE_CAST((obj), SCP_TYPE_TREE_STORE, ScpTreeStore))

#define SCP_TREE_STORE_CLASS(klass)		\
	(G_TYPE_CHECK_CLASS_CAST((klass), SCP_TYPE_TREE_STORE, ScpTreeStoreClass))

#define SCP_IS_TREE_STORE(obj)			\
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), SCP_TYPE_TREE_STORE))

#define SCP_IS_TREE_STORE_CLASS(klass)	\
	(G_TYPE_CHECK_CLASS_TYPE((klass), SCP_TYPE_TREE_STORE))

#define SCP_TREE_STORE_GET_CLASS(obj)	\
	(G_TYPE_INSTANCE_GET_CLASS((obj), SCP_TYPE_TREE_STORE, ScpTreeStoreClass))
...
#define scp_tree_store_clear(store) \
	scp_tree_store_clear_children((store), NULL, TRUE)
