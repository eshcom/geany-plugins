...
G_DEFINE_TYPE_WITH_PRIVATE(AoCopyFilePath, ao_copy_file_path, G_TYPE_OBJECT)
...
static void ao_copy_file_path_finalize(GObject *object)
{
	AoCopyFilePathPrivate *priv =
			ao_copy_file_path_get_instance_private((AoCopyFilePath *)object);
...
{
	AoCopyFilePathPrivate *priv = ao_copy_file_path_get_instance_private(self);
...
static void ao_copy_file_path_init(AoCopyFilePath *self)
{
	...
	gtk_widget_set_tooltip_text(priv->tools_menu_item, _("Copy the file path of the "
